package com.ciwei.redisserver.redisimpl;

import com.ciwei.redisserver.RedisCommand;
...
public class RedisHandle implements RedisCommand<String, Object> {
    ...
    public Map<String, Set<Object>> getAllSet() {
        Set<String> stringSet = getAllKeys();
        Map<String, Set<Object>> map = new HashMap<>(8);
        for (String k : stringSet) {
    ...
    @Override
    public Long addZSet(String key, TreeSet<ZSetOperations.TypedTuple<Object>> value) {
    ...
    public Map<String, Object> getMap(String key) {
        return redisTemplate.<String, Object>boundHashOps(key).entries();
    }

    @SuppressWarnings("unchecked")
    @Override
    public Object getMapField(String key, String field) {
    ...
    @Override
    public void addHashMap(String key, String hashKey, Object value) { redisTemplate.opsForHash().put(key, hashKey, value); }

    @Override
    public void delHashMap(String key, String hashKey) { redisTemplate.opsForHash().delete(key, hashKey); }

    @Override
    public void incrementHashMap(String key, String hashKey,long value) { redisTemplate.opsForHash().increment(key, hashKey,value); }

    @Override
    public void incrementHashMapDouble(String key, Object hashKey,double value) { redisTemplate.opsForHash().increment(key, hashKey,value); }

    @Override
    public Cursor<Map.Entry<Object, Object>> scantHashMap(String key, ScanOptions scanOptions) { return  redisTemplate.opsForHash().scan(key,scanOptions); }

    @Override
    public Object getOneHashMap(String key, String hashKey) { return  redisTemplate.opsForHash().get(key,hashKey); }
    ...
    public Set<Object> getSetUnion(String key, Set<Object> set) {
        return redisTemplate.boundSetOps(key).union(String.valueOf(set));
    }
    ...
    public Set<Object> getSetIntersect(String key, Set<Object> set) {
        return redisTemplate.boundSetOps(key).intersect(String.valueOf(set));
    }
     ...
     * @param value
     */
    public Long addUv(String key, Object... value) {
