package com.ciwei.ip2region.core;


import com.ciwei.ip2region.utils.Ip2regionUtil;
    ...
    */
    public byte[] getBytes()
    {
        ...
        */
        ...
        Ip2regionUtil.writeIntLong(b, 0, startIp);    //start ip
        Ip2regionUtil.writeIntLong(b, 4, endIp);        //end ip
