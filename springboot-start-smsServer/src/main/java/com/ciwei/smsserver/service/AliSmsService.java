...
import com.ciwei.smsserver.entity.AliSmsRequest;
...
public class AliSmsService implements SmsService {
    ...
    private static final String SYS_VERSION = "2019-06-25";
    ...
    @Override
    public Object sendVoiceTemplateSms(String templateId, BaseRequest params) throws SmsException{
        return null;
    }
}
